...
flexyAdmin.directive('flexyGrid', ['flexySettingsService','flexyApiService','flexyGridService','$routeParams', function(settings,api,grid,$routeParams) {
  'use strict';
  
  return {
    restrict:     'E',
    templateUrl:  'flexy-grid/flexy-grid-directive.html',
    replace:      true,
    scope:        {},
