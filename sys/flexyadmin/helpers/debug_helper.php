...
function trace_($a=NULL,$echo=true,$backtraceOffset=1) {
	...
	$out="<div style=\"float:right;width:33%;clear:both;position:relative;font-family:courier,serif;font-size:10px;z-index:99999;margin:0px;padding:2px;background-color:#efe;color:#000;border:solid 1px #999;opacity:.8;\"><span style=\"font-weight:bold;color:#696;\">$show #$c $type:</span>\n";
	if (is_bool($a)) {
		if ($a) $out.="'True'";
		else		$out.="'False'";
	}
