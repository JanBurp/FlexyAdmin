...
require_once dirname(__DIR__) . DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'OneTestCase.php'; 
require_once dirname(__DIR__) . DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'InheritedTest.php'; 
require_once dirname(__DIR__) . DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'NoTestCases.php'; 
require_once dirname(__DIR__) . DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'NoTestCaseClass.php'; 
require_once dirname(__DIR__) . DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'NotPublicTestCase.php'; 
require_once dirname(__DIR__) . DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'NotVoidTestCase.php'; 
require_once dirname(__DIR__) . DIRECTORY_SEPARATOR . DIRECTORY_SEPARATOR . '_files' . DIRECTORY_SEPARATOR . 'OverrideTestCase.php'; 
