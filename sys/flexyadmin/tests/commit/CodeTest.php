...
class CodeTest extends CITestCase {
  ...
  public function test_debug_code() {
    ...
    foreach ($files as $file) {
      if (!in_array($file,array('sys/flexyadmin/models/Cronjob.php','sys/flexyadmin/tests/commit/CodeTest.php','sys/flexyadmin/controllers/admin/Test.php','sys/flexyadmin/helpers/debug_helper.php'))) {
        $lines=file($file);
