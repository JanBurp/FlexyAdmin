...
/* --- Settings for table model 'cfg_ui' --- */
 ...
 */
$config['fields'] = array( 'id','path','table','field_field','str_title_nl','str_title_en','txt_help_nl','txt_help_en');
...
$config['field_info'] = array( 
		...
		'path'         => array( 'validation' => 'trim|max_length[100]' ), 
		'table'        => array( 'validation' => 'trim|max_length[100]' ), 
		'field_field'  => array( 'validation' => 'trim|max_length[255]' ), 
		'str_title_nl' => array( 'validation' => 'max_length[50]' ), 
		'str_title_en' => array( 'validation' => 'max_length[50]' ), 
		'txt_help_nl'  => array( 'validation' => '' ), 
		'txt_help_en'  => array( 'validation' => '' ), 
	);

/**
 * Hier kan een standaard volgorde worden ingesteld waarin de resultaten worden getoond.
 */
$config['order_by'] = 'field_field,table,path';
 ...
 */
$config['abstract_fields'] = array( 'str_title_nl','str_title_en');
...
$config['admin_grid'] = array( 
		'fields'        => array( 'id','path','table','field_field','str_title_nl','str_title_en','txt_help_nl','txt_help_en'), 
		'order_by'      => 'field_field,table,path', 
		'jump_to_today' => true, 
		'pagination'    => true, 
		'with'          => array( ''), 
	);
...
$config['admin_form'] = array( 
		'fields'    => array( 'id','path','table','field_field','str_title_nl','str_title_en','txt_help_nl','txt_help_en'), 
		'fieldsets' => array( 'cfg_ui' => array( 'id','path','table','field_field','str_title_nl','txt_help_nl'), 'English' => array( 'str_title_en','txt_help_en') ), 
		'with'      => array( ''), 
	);