...
/* --- Settings for table model 'log_login' --- */

/**
 * Database tabel waarvoor deze instellingen (en model) geld.
 */
$config['table'] = 'log_login';
 ...
 */
$config['fields'] = array( 'id','id_user','tme_login_time','str_changed_tables','ip_login_ip');
...
$config['field_info'] = array( 
		...
		'id_user'            => array( 'validation' => 'trim|integer' ), 
		'tme_login_time'     => array( 'validation' => '' ), 
		'str_changed_tables' => array( 'validation' => 'max_length[255]' ), 
		'ip_login_ip'        => array( 'validation' => 'trim|valid_ip|max_length[45]' ), 
	);

/**
 * Hier kan een standaard volgorde worden ingesteld waarin de resultaten worden getoond.
 */
$config['order_by'] = 'tme_login_time DESC';
 ...
 */
$config['abstract_fields'] = array( 'tme_login_time','str_changed_tables');
...
$config['admin_grid'] = array( 
		'fields'        => array( 'id','id_user','tme_login_time','str_changed_tables','ip_login_ip'), 
		'order_by'      => 'tme_login_time DESC', 
		'jump_to_today' => true, 
		'pagination'    => true, 
		'with'          => array( ''), 
	);
...
$config['admin_form'] = array( 
		'fields'    => array( 'id','id_user','tme_login_time','str_changed_tables','ip_login_ip'), 
		'fieldsets' => array( 'log_login' => array( 'id','id_user','tme_login_time','str_changed_tables','ip_login_ip') ), 
		'with'      => array( ''), 
	);