...
/* --- Settings for table model 'cfg_sessions' --- */

/**
 * Database tabel waarvoor deze instellingen (en model) geld.
 */
$config['table'] = 'cfg_sessions';
 ...
 */
$config['fields'] = array( 'id','ip_address','timestamp','data');
...
$config['field_info'] = array( 
		'id'         => array( 'validation' => 'trim|integer|required|max_length[40]' ), 
		'ip_address' => array( 'validation' => 'trim|valid_ip|max_length[45]' ), 
		'timestamp'  => array( 'validation' => '' ), 
...
$config['admin_form'] = array( 
		'fields'    => array( 'id','ip_address','timestamp','data'), 
		'fieldsets' => array( 'cfg_sessions' => array( 'id','ip_address','timestamp','data') ), 
		'with'      => array( ''), 
	);