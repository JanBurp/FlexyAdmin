 ...
 */
class Core_cfg_email extends Data_Core {
  ...
  public function get_template($template,$lang='') {
    ...
    $result = $this->select('str_subject_'.$lang.' AS str_subject, txt_email_'.$lang.' AS txt_email')->where(array('key'=>$template))->get_row();
    if ($result) {
      return array(
