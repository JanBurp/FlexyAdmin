...
parentId=get_subclass("parent_id_",$(ui.item));$("table.grid tbody tr#"+id).removeClass("parent_id_"+parentId);$("table.grid tbody tr#"+id).addClass("parent_id_"+newParentId);if(newParentId>=0){if(shifted>0)
...
show_branches(id);$(ui.item).addClass("current");}
