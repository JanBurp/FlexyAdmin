...
show_branches(id);$(ui.item).addClass("current");var url=site_url("admin/ajax/order/");var ser=serialize("table.grid tbody tr");var data={'table':table,'ids':ser};$.post(url,data,function(data){if(data.error)
