...
function doAction(obj){$(obj).children('td.id:first').html('<div class="icon wait" /></div>');uri=$(obj).children('td.uri').html();if(uri!=''){$.ajax({type:"POST",url:uri,async:'false',dataType:'json',success:function(data){console.log(data);if(data._error){ajaxError(data._error);}
