...
show_branches(id);$(ui.item).addClass("current");$('.lastnode',ui.item).remove();$('.emptynode',ui.item).remove();if(newParentId!=0){$(ui.item).addClass("parent_id_"+newParentId);var title=$("td.str:first",ui.item);var titleHtml=$(title).html();var tree=titleHtml.split('/');var treeDepth=tree.length-1;var newHtml='';for(var i=0;i<treeDepth-1;i++){newHtml+='<span class="emptynode">&nbsp;</span>';};newHtml+='<span class="lastnode">&nbsp;</span>'+tree[treeDepth];$(title).html(newHtml);}
