...
/* --- Settings for Data model 'tbl_menu' --- Created @ Mon 23 January 2017, 17:22 */
/**
 ...
 */
$config['fields'] = array('id','order','self_parent','uri','str_title','txt_text','medias_fotos','b_visible','str_module','stx_description','str_keywords');
/**
...
$config['field_info'] = array( 
		...
		'self_parent'     => array( 'default' => 0, 'validation' => array('trim','integer') ), 
		'uri'             => array( 'default' => NULL, 'validation' => array('trim','max_length[100]') ), 
		'str_title'       => array( 'default' => '', 'validation' => array('required','max_length[255]') ), 
		'txt_text'        => array( 'default' => NULL, 'validation' => array('') ), 
		'medias_fotos'    => array( 'default' => NULL, 'validation' => array('trim','max_length[1000]'), 'path' => NULL ), 
		'b_visible'       => array( 'default' => 1, 'validation' => array('') ), 
		'str_module'      => array( 'default' => NULL, 'validation' => array('max_length[30]','valid_option[,forms.contact,example]') ), 
		'stx_description' => array( 'default' => NULL, 'validation' => array('') ), 
		'str_keywords'    => array( 'default' => NULL, 'validation' => array('max_length[255]') ), 
	);
/**
...
$config['form_set'] = array( 
		'with'      => array( 'many_to_many' => array() ), 
		'fields'    => array('id','order','self_parent','uri','str_title','txt_text','medias_fotos','b_visible','str_module','stx_description','str_keywords'), 
		'fieldsets' => array( 'tbl_menu' => array('id','order','self_parent','uri','str_title','txt_text','medias_fotos','b_visible'), 'Extra' => array('str_module','stx_description','str_keywords') ), 
	);