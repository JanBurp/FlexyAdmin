...
},t,o?r:void 0,o,null)}})}),it.fn.size=function(){return this.length},it.fn.andSelf=it.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return it});var or=e.jQuery,ar=e.$;return it.noConflict=function(t){return e.$===it&&(e.$=ar),t&&e.jQuery===it&&(e.jQuery=or),it},typeof t===Ct&&(e.jQuery=e.$=it),it}),$(document).ready(function(){}),$(window).load(function(){}),$(window).resize(function(){}),function(e){var t,n,r={},i={init:function(i){return n=this,t=e.extend({},r,i),n}};e.fn.PLUGIN_NAME=function(t){return i[t]?i[t].apply(this,Array.prototype.slice.call(arguments,1)):"object"!=typeof t&&t?void e.error('Method "'+t+'" does not exist on jQuery.PLUGIN_NAME'):i.init.apply(this,arguments)}}(jQuery);
