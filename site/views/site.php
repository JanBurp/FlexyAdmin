...
// timestamp to make sure the browser gets the most recent css/js file
$timestamp=filemtime('site/assets/css/styles.min.css');
...
<?php if ($minified): ?>
  <link href="<?=$assets;?>css/styles.min.css?<?=$timestamp?>" rel="stylesheet" type="text/css" />
<?php else: ?>
  <link rel="stylesheet" href="<?=$assets;?>css/normalize.css" type="text/css" media="screen" title="no title" charset="utf-8">
  <link href="<?=$assets;?>css/text.css?<?=$timestamp?>" rel="stylesheet" type="text/css" />
  <link href="<?=$assets;?>css/layout.css?<?=$timestamp?>" rel="stylesheet" type="text/css" />
  <link href="<?=$assets;?>css/style.css?<?=$timestamp?>" rel="stylesheet" type="text/css" />
<?php endif ?>
