 ...
 * @filesource
 *
 * Extended by Jan den Besten, 2009.
 * See bottom
 *
 */
...
class CI_Loader {
	...
	function _ci_load($_ci_data)
	{
		...
		// Set unset variables [JdB 8/1/2009]
		if (!isset($_ci_path)) 		$_ci_path="";
		if (!isset($_ci_view)) 		$_ci_view="";
		if (!isset($_ci_vars)) 		$_ci_vars="";
		if (!isset($_ci_return)) 	$_ci_return="";
