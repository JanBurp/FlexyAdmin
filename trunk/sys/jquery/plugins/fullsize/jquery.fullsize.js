 ...
 * Added by Jan den Besten (2009-for FlexyAdmin)

triggerIcon - true or false (true by default) : shows trigger Icon or not.
	...
	$.fn.fullsize = function(options) {
		...
		var defaults = {  
		  	...
		  	start: function(){},
				...
				// Added by JdB
				triggerIcon:true,  		// if false, don't show the trigger icon
				triggerEvent:'click'	// choose the mouseevent (click, dblclick)..
	  	};  
		...
		return this.each(function(){
			...
			if(opts.destroy == true){
				...
				if($(this).attr("longdesc")) {
					...
					$(click).bind(opts.triggerEvent,function(){
						...
						$(full_img).load(function(){
							...
							$(this).addClass("fullsize-close"); // Added by Jdb (click on images closes)
