...
#
# DATA TABLES: cfg_admin_menu, cfg_configurations, cfg_email, cfg_field_info, cfg_img_info, cfg_media_info, cfg_table_info, cfg_ui, cfg_user_groups, cfg_users, rel_users__groups, res_media_files, tbl_links, tbl_menu, tbl_site
...
INSERT INTO `cfg_admin_menu` (`id`, `order`, `str_ui_name`, `b_visible`, `id_user_group`, `str_type`, `api`, `path`, `table`, `str_table_where`) VALUES ('5', '6', '# all media (if user has rights)', '1', '3', 'all_media', '', '', '', '');
INSERT INTO `cfg_admin_menu` (`id`, `order`, `str_ui_name`, `b_visible`, `id_user_group`, `str_type`, `api`, `path`, `table`, `str_table_where`) VALUES ('6', '10', '# all tools (if user has rights)', '1', '3', 'tools', '', '', '', '');
INSERT INTO `cfg_admin_menu` (`id`, `order`, `str_ui_name`, `b_visible`, `id_user_group`, `str_type`, `api`, `path`, `table`, `str_table_where`) VALUES ('7', '14', '# all config tables (if user has rights)', '1', '1', 'all_cfg_tables', '', '', '', '');
...
INSERT INTO `cfg_admin_menu` (`id`, `order`, `str_ui_name`, `b_visible`, `id_user_group`, `str_type`, `api`, `path`, `table`, `str_table_where`) VALUES ('9', '7', '', '1', '3', 'seperator', '', '', '', '');
INSERT INTO `cfg_admin_menu` (`id`, `order`, `str_ui_name`, `b_visible`, `id_user_group`, `str_type`, `api`, `path`, `table`, `str_table_where`) VALUES ('10', '11', '', '1', '3', 'seperator', '', '', '', '');
INSERT INTO `cfg_admin_menu` (`id`, `order`, `str_ui_name`, `b_visible`, `id_user_group`, `str_type`, `api`, `path`, `table`, `str_table_where`) VALUES ('11', '8', '_stats_menu', '1', '3', 'api', 'API_plugin_stats', '', '', '');
INSERT INTO `cfg_admin_menu` (`id`, `order`, `str_ui_name`, `b_visible`, `id_user_group`, `str_type`, `api`, `path`, `table`, `str_table_where`) VALUES ('12', '9', '', '1', '3', 'seperator', '', '', '', '');
INSERT INTO `cfg_admin_menu` (`id`, `order`, `str_ui_name`, `b_visible`, `id_user_group`, `str_type`, `api`, `path`, `table`, `str_table_where`) VALUES ('16', '12', '# all result tables (if there are any)', '1', '1', 'all_res_tables', '', '', '', '');
INSERT INTO `cfg_admin_menu` (`id`, `order`, `str_ui_name`, `b_visible`, `id_user_group`, `str_type`, `api`, `path`, `table`, `str_table_where`) VALUES ('17', '13', '', '1', '1', 'seperator', '', '', '', '');
INSERT INTO `cfg_admin_menu` (`id`, `order`, `str_ui_name`, `b_visible`, `id_user_group`, `str_type`, `api`, `path`, `table`, `str_table_where`) VALUES ('18', '5', '', '1', '3', 'seperator', '', '', '', '');
...
INSERT INTO `rel_users__groups` (`id`, `id_user`, `id_user_group`) VALUES ('30', '1', '1');
...
INSERT INTO `tbl_site` (`id`, `str_title`, `str_author`, `url_url`, `email_email`, `stx_description`, `stx_keywords`, `str_google_analytics`) VALUES ('1', 'FlexyAdmin Demo', 'Jan den Besten', 'http://www.flexyadmin.com/', 'info@flexyadmin.com', '', '', '');
